...
'''
Logistics
- The final exam will be on Gradescope Thursday 6/9 8-10AM
- The final exam will be cummulative
- Will look similar to Quizzes/hws in terms of questions asked
    - T/F
    - Short answers
        - Briefly describe/define/state
    - Write code satisfying a certain specification
    - Write solutions (autograded)
- We will be monitoring Piazza during the final exam
    - For CLARIFYING questions, you may post a PRIVATE question
      to instructors
    - If there needs to be a change/modification in any question,
      then we will publicly post this on Piazza
'''
...
- Object Oriented Programming (OOP)
    ...
    - Overloading operators
        - __str__, __add__, __le__, __ge, __lt__, __gt__,...
    - Inheritance
        - Know the implementation and behavior of fields/methods and
...
- Algorithm Analysis and O-notation
    - Know how to derive the O-notation for various datat structure and code segments
- Binary Search
...
- Linear Data Structures
    - Know implementations (as covered in textbook/lectures) as well as possible variations
        - Stacks, Queues, Deques, Linked List, Ordered Linked Lists
- Sorting Algorithms
...
- Trees
    - Terminology
    - Know min-heap/max-heap data structure implementation (and underlying list representation)
    - Binary Trees
